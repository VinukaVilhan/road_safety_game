...
class DrivingLevelsService {
  ...
  static List<GameLevel> getLevelsForTopic(DrivingTopic topic) {
    switch (topic) {
      ...
      case DrivingTopic.WeatherConditions:
        return _weatherConditionsLevels;
  ...
  static final List<GameLevel> _junctionsLevels = [
    ...
    GameLevel(
      ...
      topicLevel: 4,
      unlockRequirementIds: ["junctions_t_right"],
      mapAsset: 'roundabout_junction.tmx',
      scenarioId: 'roundabout_basics',
      enableDrivingRules: false,
    ),
    GameLevel(
  ...
  static final List<GameLevel> _roadMarkingsLevels = [
    GameLevel(
      ...
      topicLevel: 1,
      unlockRequirementIds: [],
      mapAsset: 'lane_markings_solid.tmx',
    ...
    GameLevel(
      ...
      mapAsset: 'lane_markings_dashed.tmx',
    ...
    GameLevel(
      id: "markings_junction_box",
      number: 5,
      name: "Junction Box Level",
      description: "Hatched junction box markings â€” enter only when you can clear; do not stop inside",
      isUnlocked: false,
      topic: DrivingTopic.RoadMarkings,
      moduleId: roadMarkingsModuleOther,
      topicLevel: 5,
      unlockRequirementIds: ["markings_zebra"],
      mapAsset: 'junction_box.tmx',
      scenarioId: 'cross_junction_basics',
    ),
    GameLevel(
      ...
      description: "Restricted lanes and special markings â€” under development",
      isUnlocked: false,
      topic: DrivingTopic.RoadMarkings,
      moduleId: roadMarkingsModuleOther,
      topicLevel: 6,
      unlockRequirementIds: ["markings_junction_box"],
    ),
    GameLevel(
      id: "markings_complex",
      number: 7,
  ...
  static final List<GameLevel> _emergencySituationsLevels = [
    ...
    GameLevel(
      ...
      topicLevel: 1,
      unlockRequirementIds: [],
      mapAsset: 'ambulance_reaction.tmx',
      scenarioId: 'emergency_ambulance',
    ),
  ];

  // ========== WEATHER CONDITIONS LEVELS ==========
  static final List<GameLevel> _weatherConditionsLevels = [
    GameLevel(
      id: "emergency_weather",
      number: 1,
      name: "Adverse Weather",
      description: "Drive safely in rain with reduced grip and visibility",
      isUnlocked: true,
