...
class DrivingLevelsService {
  ...
  static final List<GameLevel> _roadMarkingsLevels = [
    ...
    GameLevel(
      ...
      description: "Hatched junction box markings — enter only when you can clear; do not stop inside",
      difficulty: LevelDifficulty.Medium,
      isUnlocked: false,
      topic: DrivingTopic.RoadMarkings,
      moduleId: roadMarkingsModuleOther,
    ...
    GameLevel(
      ...
      description: "Restricted lanes and special markings — under development",
      difficulty: LevelDifficulty.Medium,
      isUnlocked: false,
      topic: DrivingTopic.RoadMarkings,
      moduleId: roadMarkingsModuleOther,
